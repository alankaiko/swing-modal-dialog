...
public class ListaExame extends FormTableGeneric {
    ...
    private TabelaGenerica<Exame> tabelaGenerica;
    ...
    protected void carregarObjetos() {
        ...
        this.pageResponse = this.exameService.filtrando(filtro);
        this.tabelaGenerica = new TabelaGenerica<>(new String[]{"Código", "Título"},
                Arrays.asList(Exame::getCodigo, Exame::getTitulo), this.pageResponse);
    }
    ...
    protected void criarTabela() {
        ...
        panel.add(new JLabel("Lista de Exames"), "gapx 20");
