...
public class FormConvenio extends Form {
    ...
    private void init() {
        ...
        this.add(this.createInfo("Tabela de Convênios", "Teste", 1));
        this.add(this.createTab(), "gapx 7 7");
    }
    ...
    private Component createTab() {
        ...
        tabb.addTab("Custom table", this.createBorder(this.createCustomTable()));
        return tabb;
    }
    ...
    private Component createHeaderAction() {
        ...
        JButton cmdCreate = new JButton("Adicionar");
        cmdCreate.setPreferredSize(new Dimension(130, 30));
        JButton cmdEdit = new JButton("Editar");
        cmdEdit.setPreferredSize(new Dimension(130, 30));
        JButton cmdDelete = new JButton("Deletar");
        cmdDelete.setPreferredSize(new Dimension(130, 30));
