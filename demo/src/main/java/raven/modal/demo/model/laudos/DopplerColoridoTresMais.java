...
@Setter
@Entity
@Table(name = "dopplercoloridotresmais")
public class DopplerColoridoTresMais extends LaudoPadrao {
    ...
    @OneToOne(cascade = CascadeType.ALL, fetch = FetchType.EAGER)
    @JoinColumn(name = "tbl_numero_fetos_id", referencedColumnName = "codigo")
    private NumeroFetos numeroFetos;
