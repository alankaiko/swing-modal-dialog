...
@Setter
@Entity
@Table(name = "pelvicaendovaginal")
public class PelvicaEndovaginal extends LaudoPadrao {
    ...
    @OneToOne(cascade = CascadeType.ALL, fetch = FetchType.EAGER)
    @JoinColumn(name = "tbl_girads_id", referencedColumnName = "codigo")
    private GIRads giRads;
